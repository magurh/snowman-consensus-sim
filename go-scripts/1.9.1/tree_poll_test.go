...
func TestTreePollVisualization(t *testing.T) {
    ...
    params := snowball.Parameters{
        K:            5, // number of samples (not heavily used in this simple test)
        Alpha:        3, // minimum votes to potentially switch preference
        BetaVirtuous: 2, // confidence threshold for virtuous decisions
        BetaRogue:    4, // confidence threshold for rogue decisions
    }
